...
import com.example.zomato_plus.model.OrderDetails
import com.example.zomato_plus.util.FETCH_PREVIOUS_ORDERS
...
class OrderHistoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.order_history, container, false)
