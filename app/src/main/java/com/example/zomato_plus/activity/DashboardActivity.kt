...
import com.example.zomato_plus.fragments.*
import com.example.zomato_plus.fragments.RestaurantFragment.Companion.resId
...
class DashboardActivity : AppCompatActivity(), drawerlocker {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        * The method of using XML to add drawer layout is a better way*/
        val convertView = LayoutInflater.from(this@DashboardActivity).inflate(R.layout.activity_drawer, null)
